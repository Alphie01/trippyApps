import 'package:trippy_desk_app/core/classes/cityGuide/subclasses/city_desc.dart';
import 'package:trippy_desk_app/core/classes/cityGuide/subclasses/weather.dart';
  ...
  static Cities selectedCites = Cities(
      ...
      cityScoreList: [
        CityScore(
            ...
            scoresDesc:
                "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.",
            scoreIcon: FontAwesomeIcons.medkit,
            scoreCount: 66),
        CityScore(
            scoreName: 'Aile İçin',
            scoresDesc:
      ...
      cityProsCons: [
        CityProsCons(
            prosconsTitle: 'Yaşanabilir Maliyet', prosconsIsPros: true),
        ...
        CityProsCons(
            prosconsTitle: 'Konumşma Özgürlüğü', prosconsIsPros: false),
